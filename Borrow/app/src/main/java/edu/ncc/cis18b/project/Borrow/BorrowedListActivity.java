...
public class BorrowedListActivity extends ActionBarActivity {
    ...
    private void initializeActionBar() {
        // set title
        setTitle("Borrow :: Borrowed Items");
    ...
    private void initializeList()
    {
        ...
        ft.add(R.id.borrowedItemsContainer, listFragment);
    ...
    {
        BorrowQueryManager.queryBorrowedObjects(listFragment);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_borrowed_list, menu);
        return true;
    }
